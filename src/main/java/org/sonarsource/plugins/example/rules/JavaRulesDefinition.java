...
public class JavaRulesDefinition implements RulesDefinition {
    ...
    public void define(Context context) {
        LOGGER.info("--- JavaRulesDefinition.define");
        ...
        NewRule x1Rule = repository
            ...
            .setTags("style", "stupid") // optional tags
            .setStatus(RuleStatus.BETA) // optional status. Default value is READY.
            .setSeverity(Severity.MINOR); // default severity when the rule is activated on a Quality profile. Default value is MAJOR.
